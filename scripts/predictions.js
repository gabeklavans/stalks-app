...
export default class Predictor {
  ...
  * generate_pattern_0_with_lengths(
    ...
    */
    ...
    yield {
      pattern_description: 'patterns.fluctuating',//i18next.t("patterns.fluctuating"),
      pattern_number: 0,
  ...
  * generate_pattern_1_with_peak(given_prices, peak_start) {
    ...
    */
    ...
    yield {
      pattern_description: 'patterns.large-spike',//i18next.t("patterns.large-spike"),
      pattern_number: 1,
      prices: predicted_prices,
      probability,
    };
  ...
  * generate_pattern_2(given_prices) {
    ...
    */
    ...
    yield {
      pattern_description: "patterns.decreasing",//i18next.t("patterns.decreasing"),
      pattern_number: 2,
      prices: predicted_prices,
      probability,
    };
  ...
  * generate_pattern_3_with_peak(given_prices, peak_start) {
    ...
    */
    ...
    yield {
      pattern_description: "patterns.small-spike",//i18next.t("patterns.small-spike"),
      pattern_number: 3,
      prices: predicted_prices,
      probability,
    };
  ...
  * generate_possibilities(sell_prices, first_buy, previous_pattern) {
  ...
  analyze_possibilities() {
    ...
    generated_possibilities.unshift({
      pattern_description: "patterns.all",//i18next.t("patterns.all"),
      pattern_number: 4,
